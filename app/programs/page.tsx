            ...
            <div className="relative bg-[#EEEFF1] rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex items-start justify-between p-6 pb-4 pt-7">
                <div>
                  ...
                  <h3 className="font-heading text-xl font-extrabold text-[#1A1A1A]">Enroll in {courseName}</h3>
              ...
              {status === 'success' ? (
                ...
                >
                  ...
                  <h4 className="font-heading text-xl font-extrabold text-[#1A1A1A] mb-2">Enrollment Submitted!</h4>
    ...
    >
      ...
      <div className="p-8 flex flex-col flex-1">
        ...
        <div className="flex items-start justify-between mb-5">
          <h3 className="font-heading text-xl font-bold text-[#8C1B2E] flex-1 leading-snug pr-4">
            {program.title}
          </h3>
          <motion.div
        ...
        {program.schedule && (
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="font-heading font-bold text-[#8C1B2E] text-sm tracking-wide uppercase">Class Schedules</h4>
            </div>
        ...
        {program.features && (
          <div className="mb-6">
            <h4 className="font-heading font-bold text-[#8C1B2E] text-sm tracking-wide uppercase mb-3 flex items-center gap-2">
        ...
        {program.subjects && (
          <div className="mb-6">
            <h4 className="font-heading font-bold text-[#8C1B2E] text-sm tracking-wide uppercase mb-3">                Subjects Offered
            </h4>
        ...
        <div className="mt-auto grid grid-cols-2 gap-3">
          ...
          <Link href={`/programs/${program.title.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`} className="w-full">
            <motion.button
              whileHover={{ scale: 1.03, backgroundColor: 'rgba(140,27,46,0.05)' }}
              whileTap={{ scale: 0.97 }}
              className="w-full h-full text-sm font-bold text-[#8C1B2E] border-2 border-[#8C1B2E] py-3 px-4 rounded-xl transition-colors duration-200 flex items-center justify-center"
            >
              {program.viewDetailsCta || 'View Details'}
            </motion.button>
          </Link>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 0.7, delay: 0.3, ease: EASE }}
              />
              <p className="mt-6 text-lg text-[#1A1A1A]/70 max-w-2xl mx-auto italic">
                ...
                {islamicPrograms.map((course, index) => (
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                    />
                    <p className="font-heading font-bold text-[#8C1B2E] text-sm mb-1">{course.name}</p>
              ...
              >
                {howSteps.map((item, index) => (
                  ...
                  >
                    ...
                    <h4 className="font-heading font-bold text-[#8C1B2E] mb-2 text-base">{item.title}</h4>
